import { Body, Controller, Delete, Get, Param, Post, HttpStatus, Query, Res, ParseIntPipe } from '@nestjs/common';
...
export class SlotsController {
    ...
    freeParkingSlot(@Param('id', ParseIntPipe) id: number, @Res() res: Response) {
